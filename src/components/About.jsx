export default function About() {
    const tools = [
        ...
        { name: 'nodejs', icon: './assets/node.png', },
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">Full-Stack Developer with 3 years of experience building web applications. 
                        Specialize in React frontends and Node.js backends with database integration. 
                        Passionate about creating functional, scalable solutions.</p>
