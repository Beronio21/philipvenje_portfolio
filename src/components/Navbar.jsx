    ...
    return (
        <>
            ...
            <nav ref={navRef} className="w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50">
                ...
                <a href="#top" className="text-lg font-bold mr-8">Philip Venje</a>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <a href="#contact" className="hidden lg:flex items-center gap-3 px-8 py-1.5 rounded-full ml-4 font-Ovo bg-black text-white dark:bg-white dark:text-black hover:bg-gray-800 dark:hover:bg-gray-200">
                        Contact <img src="./assets/right-arrow-white.png" alt="" className="w-4 dark:invert" />
                    </a>
